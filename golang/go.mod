module github.com/killin10/playground/golang
...
replace golang.org/x/tour v0.0.0-20190318020441-db40fe78fefc => github.com/golang/tour v0.0.0-20190318020441-db40fe78fefc
...
replace golang.org/x/tools v0.0.0-20190312164927-7b79afddac43 => github.com/golang/tools v0.0.0-20190312164927-7b79afddac43
